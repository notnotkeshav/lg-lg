...
frappe.query_reports["Opportunity HP Summary"] = {
    "filters": [
        {
            "fieldname": "group_by",
            "label": __("Group By"),
    ...
    "formatter": function (value, row, column, data, default_formatter) {
        ...
        if (column && column?.fieldname?.includes("total_hp_display", "total_in_warrenty", "total_out_warrenty", "total_amc_active", "total_amc_expired")) {
